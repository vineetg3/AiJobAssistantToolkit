      ...
      <div>
        ...
        <div class="container-fluid">
          <div class="row">
            {isQueryBar && (
              <nav
                class="col-sm-3 col-lg-2  .d-sm-none .d-md-block bg-light sidebar mt-4 pt-4 px-1 position-fixed"
                    ...
                    <li>
                      <div class=" mb-2 mx-2">
                        <input
                          ...
                          type="search"
                          placeholder="Company,Salary,etc.."
                          id="form1"
                          value={searchValue}
            ...
            <div class={rightPaneCss}>
              ...
              {!isLoading &&
                ...
                userJobsList.map((job) => {
                  ...
                  replaceNull(job);
                  var statusTheme = StatusItems.find(
                    (obj) => obj.status === job.status
                  );
